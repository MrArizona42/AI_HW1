...
class PreprocessorBasic(BaseEstimator, TransformerMixin):
    def __init__(self,
                fill_method='median',
                scalar=0
            ) -> None:
    ...
    def transform(self, X, y=None):
        ...
        print("Resulting shapes:", X_transformed.shape)
...
class PreprocessorRelativePower(BaseEstimator, TransformerMixin):
    def __init__(self,
                fill_method='median',
                scalar=0
            ) -> None:
...
class PreprocessorYearSquared(BaseEstimator, TransformerMixin):
    def __init__(self,
                fill_method='median',
                scalar=0
            ) -> None:
...
class PreprocessorTFIDF(BaseEstimator, TransformerMixin):
    def __init__(self,
                fill_method='median',
                scalar=0
            ) -> None:
...
class PreprocessorNanCols(BaseEstimator, TransformerMixin):
    def __init__(self,
                fill_method='median',
                scalar=0
            ) -> None:
    ...
    def transform(self, X, y=None):
        ...
        # print('filled with:')
        # print(self.fill_vals)

        print("Resulting shapes:", X_transformed.shape)
        # print('Remaining nans:')
        # print(X_transformed.isna().mean())
    ...
    def fill_nans(self, X):
        # X = pd.merge(
        #     left=X,
        #     right=X.loc[:, (X.isna().mean() > 0)].isna().astype('int'),
        #     left_index=True,
        #     right_index=True,
        #     suffixes=['', '_isna']
        # )
